 ...
 */
   ...
   // Explicacion en el archivo leeme.txt
      }
    ...
    */
      ...
      // Inicio modificacion
         ...
         varInt = (int)varLong;
         System.out.println(varLong+ " " +varByte+ " " +varShort+ " " +varInt);
    ...
    */
      ...
      // Inicio modificacion
         ...
         System.out.println(varByte + " " + varShort + " " + varInt + " " + varLong + " " + varFloat + " " + varDouble);
        // Fin modificacion
      }
