...
public class Apartado030202 extends Apartado {
	...
	public void ejercicio03() {
		...
		while(numeroMenor<numeroMayor){
			if(numeroMenor%2==0){
				sumaPares = sumaPares + numeroMenor;
			}else{
				sumaImpares = sumaImpares + numeroMenor;
			}
	...
	public void ejercicio04() {
		...
		System.out.println("Introduce los numeros enteros de la serie: ");
		while(numeroCincos!=3){
			numero= Teclado.readInteger();
			sumaNumeros = sumaNumeros + numero;
			if(numero==5){
				numeroCincos = numeroCincos + 1;
			}
			cantidadNumeros = cantidadNumeros + 1;
		}
		float media = (float) sumaNumeros/ cantidadNumeros;
		System.out.println("La media de la serie es: "+media);
	...
	public void ejercicio05() {
		...
		NumeroEntero n1 = new NumeroEntero(Teclado.readInteger());
		System.out.println(n1.numeroDigitos());
		System.out.println(n1.inverso());
		System.out.println(n1.esCapicua());
        // Fin modificacion
	}
	...
	public void ejercicio06() {
		...
		System.out.println(j1.getPuntosATP()+" "+j2.getPuntosATP());
        partido.jugar();
